...
@section('content')
    ...
    <div class="row">
    {!! Form::open(['route' => ['tfees.store',"btc"], 'data-parsley-validate' => '']) !!}
        <div class="col-md-2">
            <h2>Bitcoin Fees</h2>
        </div>
        ...
        <div class="col-md-8" style="margin-top:25px">
                ...
                <div class='col-md-3'>
                {{ Form::text('fee_deposit', null, ['class' => 'form-control','placeholder' => 'Deposit Fee (BTC)', 'required' => '', 'data-parsley-type' => 'number']) }}
                </div>
                <div class='col-md-3'>
                {{ Form::text('fee_withdraw', null, ['class' => 'form-control','placeholder' => 'Withdraw Fee (BTC)', 'required' => '', 'data-parsley-type' => 'number']) }}
                </div>
                ...
                <tbody>
                    ...
                    @foreach ($fees as $key => $fee)
                        ...
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>{{ $fee->exchange }}</td>
                            <td>{{ $fee->fee_deposit.' BTC' }}</td>
                            <td>{{ $fee->fee_withdraw.' BTC' }}</td>
