...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <h1 style='text-align: right'>Bitcoin   |   Binance</h1>
    ...
    <div class = "row">
        <div class="col-md-10">
            ...
            {!! Form::open(['route' => ['whales.store','binance','btc']]) !!}
        ...
        <h4 style='text-align: right'>Current Rate: <p style='display:inline'>@{{(-orderbooks[0][0].price-orderbooks[0][1].price)/-2}} </p></h4>
        </div>
    </div>
