...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <h1 style='text-align: right'>Bitcoin-Ethereum   |   Binance</h1>
    ...
    <div class = "row">
        <div class="col-md-10">
            ...
            {!! Form::open(['route' => ['whales.store','binance','btceth']]) !!}
        ...
        <h4 style='text-align: right'>Current Rate: <p style='display:inline'>@{{Math.round((-orderbooks[0][6].price-orderbooks[0][7].price)/-2*1000000)/1000000}} </p></h4>
        </div>
    </div>
